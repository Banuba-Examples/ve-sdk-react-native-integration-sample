...
1. __Set Banuba Video Editor SDK token__  
   Set Banuba license token [within the app](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/android/app/src/main/java/com/vesdkreactnativeintegrationsample/MainApplication.java#L38).<br></br>
...
3. __Add SDK dependencies initializer class__ </br>
...
4. __Initialize Video Editor SDK in your application__ </br>
   ...
   [See example](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/android/app/src/main/java/com/vesdkreactnativeintegrationsample/MainApplication.java#L105)</br><br>
...
5. __Add Video Editor React Package__ </br>
   ...
   create new ReactPackage for Video Editor and add it in ```List<ReactPackage> getPackages()``` method in your [Application](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/android/app/src/main/java/com/vesdkreactnativeintegrationsample/MainApplication.java#L54).<br>
...
9. __Start Video Editor SDK__ </br>
   ...
   <Button
        ...
        />
   ```
   [See example](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/App.js#L80)</br><br>
   Technically it invokes ```VideoCreationActivity.startFromCamera(...)``` method to start Video Editor SDK from Camera screen.</br>
   [See example](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/master/android/app/src/main/java/com/vesdkreactnativeintegrationsample/VideoEditorModule.kt#L118)</br><br>
   ...
   in [VideoEditorModule](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/master/android/app/src/main/java/com/vesdkreactnativeintegrationsample/VideoEditorModule.kt#38).</br><br>
   ...
   [See example](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/App.js#L84)<br></br>
...
11. __Custom Audio Browser experience__ </br>
    ...
    To check out the simplest experience on Flutter you can set ```true``` to [USE_CUSTOM_AUDIO_BROWSER](https://github.com/Banuba-Examples/ve-sdk-react-native-integration-sample/blob/main/android/app/src/main/java/com/vesdkreactnativeintegrationsample/MainApplication.java#L34)  
